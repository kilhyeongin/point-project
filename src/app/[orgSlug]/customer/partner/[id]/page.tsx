...
import ApplyPartnerButton from "@/app/[orgSlug]/customer/ApplyPartnerButton";
      ...
      <div className="max-w-2xl mx-auto pb-28">
        ...
        <div className="px-4 space-y-4 pt-5">
          ...
          <div className="bg-card shadow-card rounded-2xl p-5 space-y-3">
            <h2 className="text-base font-black text-foreground">예약 및 신청</h2>
            <ApplyPartnerButton
            ...
            kakaoChannelUrl={kakaoChannelUrl || undefined}
            scheduleConfig={{
