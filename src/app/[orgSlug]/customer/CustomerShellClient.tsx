// src/app/[orgSlug]/customer/CustomerShellClient.tsx
"use client";
...
export default function CustomerShellClient({
  ...
  const isHome = pathname === `/${orgSlug}/customer` || pathname.startsWith(`/${orgSlug}/customer/category/`);
  const isFavorites = pathname === `/${orgSlug}/customer/favorites`;
