          ...
          <div className="mt-3 border border-border rounded-xl overflow-hidden">
            {linesLoading ? (
              ...
              <>
                ...
                <div className="hidden md:block overflow-x-auto">
                  <div className="min-w-[980px]">
                    <div className="grid grid-cols-[220px_80px_100px_100px_100px_100px_80px_80px_1fr] gap-2 px-4 py-2 text-xs font-bold text-muted-foreground border-b border-border bg-muted/30">
                      <div>업체</div>
                      <div>상태</div>
                      <div className="text-right">방문고객</div>
                      <div className="text-right">지급포인트</div>
                      <div className="text-right">사용포인트</div>
                      <div className="text-right">지급액</div>
                      <div className="text-right">계약완료</div>
                      <div className="text-right">방문취소</div>
                    ...
                    {lines.map((l) => (
                      <div
                        key={l.id}
                        className="grid grid-cols-[220px_80px_100px_100px_100px_100px_80px_80px_1fr] gap-2 px-4 py-3 border-b border-border last:border-0 text-sm items-center"
                      >
                        <div>
                          <div className="font-black text-foreground">
                            {l.counterparty
                        ...
                        <div className="text-right font-black">{formatNumber(l.visitorCount ?? 0)}명</div>
                        <div className="text-right font-black">{formatNumber(l.issuedPoints ?? 0)}P</div>
                        ...
                        <div className="text-right font-black">{formatNumber(l.completedCount ?? 0)}건</div>
                        <div className="text-right font-black">{formatNumber(l.cancelledCount ?? 0)}건</div>
                ...
                <div className="flex md:hidden flex-col gap-3 p-4">
                  {lines.map((l) => (
                    <article key={l.id} className="border border-border rounded-2xl p-4 bg-muted/20">
                      ...
                      <div className="mt-3 space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">방문 고객</span>
                          <span className="text-right">{formatNumber(l.visitorCount ?? 0)}명</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">지급 포인트</span>
                          <span className="text-right">{formatNumber(l.issuedPoints ?? 0)}P</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">사용 포인트</span>
                          <span className="text-right">{formatNumber(l.usedPoints)}P</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">지급액</span>
                          <span className="text-right">{formatNumber(l.netPayable)}P</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">계약 완료</span>
                          <span className="text-right">{formatNumber(l.completedCount ?? 0)}건</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">방문 취소</span>
                          <span className="text-right">{formatNumber(l.cancelledCount ?? 0)}건</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">지급참조</span>
                          <span className="text-right break-words">{l.payoutRef || "-"}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground w-24 shrink-0">메모</span>
