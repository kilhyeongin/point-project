  ...
  return (
    <main className="min-h-screen bg-background px-4 py-6 md:px-8 md:py-8 space-y-5">
        ...
        <div className="bg-card shadow-card rounded-2xl p-5 flex flex-col gap-5">
          <div>
            ...
            <div className="space-y-2">
              {[
                ...
                {
                  href: "/admin/issue-requests",
                  label: "지급요청 승인 대기",
                  count: pendingIssueCount,
                  sub: "고객 포인트 지급 승인 처리",
                },
                {
                  href: "/admin/use-requests",
                  label: "사용요청 승인 대기",
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { href: "/admin/topup", label: "관리자 수동 충전" },
                { href: "/admin/adjust", label: "포인트 조정" },
                { href: "/admin/ledger", label: "원장 조회" },
                { href: "/admin/settlements", label: "월정산 관리" },
                { href: "/admin/accounts", label: "계정 조회" },
              ].map((item) => (
                <a
                  key={item.href}
                  href={item.href}
      ...
      <section className="bg-card shadow-card rounded-2xl p-5">
        ...
        {/* Search Bar */}
        <form action="/admin" method="GET" className="flex flex-wrap gap-2 mb-3">
          {activeRole !== "ALL" && (
